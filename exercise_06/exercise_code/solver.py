...
class Solver(object):
    ...
    def __init__(self, model, train_dataloader, val_dataloader,
                 ...
                 optimizer=Adam, verbose=True, print_every=1, lr_decay=1.0, decay_step=10,
                 **kwargs):
        """
    ...
    def train(self, epochs=100, patience=None):
        ...
        print("train accuracy: %.5f   val accuarcy: %.5f" % (
        self.get_dataset_accuracy(self.train_dataloader), self.get_dataset_accuracy(self.val_dataloader)))
    ...
    def get_dataset_accuracy(self, loader):
        ...
        labels, preds, acc = self.model.get_dataset_prediction(loader)
