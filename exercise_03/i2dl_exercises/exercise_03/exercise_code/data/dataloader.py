...
class DataLoader:
    ...
    def __iter__(self):
        ...
        for index in index_iterator:
            ...
            elif (not self.drop_last) and idx == len(self.dataset):
    ...
    def __len__(self):
        ...
        tail = 0 if self.drop_last or len(self.dataset) % self.batch_size == 0 else 1
        length = int(len(self.dataset) / self.batch_size) + tail
