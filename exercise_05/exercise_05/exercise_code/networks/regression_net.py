...
class RegressionNet(Network):
    ...
    def forward(self, X):
        ...
        y1, cache_affine1 = affine_forward(X, W1, b1)
        s, cache_sigmoid = sigmoid_forward(y1)
        y, cache_affine2= affine_forward(s, W2, b2)
    ...
    def backward(self, dy):
        ...
        ds = sigmoid_backward(dy2, cache_sigmoid)
        dy1, dW1, db1 = affine_backward(ds, cache_affine1)
